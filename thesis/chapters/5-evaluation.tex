...
\begin{figure}[H]
    ...
    \caption[Baseline vs Learned Two Quadrotor Recovery]{Comparison of the learned policy with the baseline method from \autocite{wahba_kinodynamic_2024}. Recovery of two quadrotors with payload from harsh conditions. The top plot is a top-down  (xy) view, while the bottom one is a side view (xz).}
